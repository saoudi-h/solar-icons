...
| `check-inventory.ts`       | Computes the canonical logical-icon/SVG/metadata counts from `packages/core` and reports stale generated icon lists; `--check-generated` turns those warnings into failures.                                            |
