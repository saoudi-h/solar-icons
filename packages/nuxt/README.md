...
Nuxt module for Solar Icons. This package provides 8,274 SVG icons across 6 styles (Bold, Broken, Linear, Outline, Bold Duotone, Line Duotone), optimized for Nuxt applications.
