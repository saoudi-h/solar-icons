...
CLI for Solar Icons — 1,451 icons × 6 styles. Search, get and list icons locally (offline) via `@solar-icons/static`. Designed as the single source of truth for `skills` and the future MCP server.
