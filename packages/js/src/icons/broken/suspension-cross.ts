...
const SuspensionCrossBrokenIcon: IconNode = [
  [
    "path",
    {
  ...
  [
    "path",
    {
      "d": "M21 19.5C21 19.9647 21 20.197 20.9616 20.3902C20.8038 21.1836 20.1836 21.8038 19.3902 21.9616C19.197 22 18.9647 22 18.5 22C18.0353 22 17.803 22 17.6098 21.9616C16.8164 21.8038 16.1962 21.1836 16.0384 20.3902C16 20.197 16 19.9647 16 19.5V17.5C16 17.0353 16 16.803 16.0384 16.6098C16.1962 15.8164 16.8164 15.1962 17.6098 15.0384C17.803 15 18.0353 15 18.5 15C18.9647 15 19.197 15 19.3902 15.0384C20.1836 15.1962 20.8038 15.8164 20.9616 16.6098",
      "stroke": "currentColor",
      "stroke-linecap": "round"
    }
  ]
...
export { SuspensionCrossBrokenIcon as default };
