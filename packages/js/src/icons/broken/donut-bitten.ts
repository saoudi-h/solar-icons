...
const DonutBittenBrokenIcon: IconNode = [
  [
    "circle",
    {
      "cx": "12",
  ...
  [
    "path",
    {
      "d": "M3.64702 17.5C2.60596 15.9221 2 14.0318 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 12.9417 21.8698 13.8529 21.6265 14.7168",
      "stroke": "currentColor",
      "stroke-linecap": "round",
  ...
  [
    "path",
    {
      "d": "M21.6266 14.7167C21.0862 14.256 20.1862 14.2717 19.4788 14.7949C18.8772 15.2397 18.5858 15.9252 18.6855 16.5211L18.5841 16.6225L18.2496 16.1703C17.6339 15.3377 16.322 15.2638 15.3195 16.0052C14.317 16.7466 14.0035 18.0225 14.6192 18.8551L14.8045 19.1056L14.6192 19.2909C14.1064 19.1294 13.4717 19.2373 12.9441 19.6275C12.1421 20.2206 12.0075 21.3338 12.5001 21.9999C12.3458 22.007 12.1561 21.9999 12.0001 21.9999C10.4355 21.9999 8.95475 21.6406 7.63599 20.9999",
      "stroke": "currentColor",
      "stroke-linecap": "round",
      "stroke-linejoin": "round"
    }
...
export { DonutBittenBrokenIcon as default };
