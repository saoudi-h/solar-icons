...
const ShareCircleBrokenIcon: IconNode = [
  [
    "path",
    {
  ...
  [
    "path",
    {
      "d": "M5.5 15C7.15685 15 8.5 16.3431 8.5 18C8.5 19.6569 7.15685 21 5.5 21C3.84315 21 2.5 19.6569 2.5 18",
      "stroke": "currentColor",
      "stroke-linecap": "round"
    }
  ],
...
export { ShareCircleBrokenIcon as default };
