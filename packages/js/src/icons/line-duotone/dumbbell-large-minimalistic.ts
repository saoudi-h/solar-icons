...
const DumbbellLargeMinimalisticLineDuotoneIcon: IconNode = [
  [
    "path",
    {
      "d": "M8.31885 12.1982L12.1989 8.31823M15.3029 11.4222L11.4229 15.3023",
      "stroke": "currentColor",
  ...
  [
    "path",
    {
      "d": "M18.0188 2.49805L21.1228 5.60206",
      "stroke": "currentColor",
  ...
  [
    "path",
    {
      "d": "M2.49756 18.0186L5.60157 21.1226",
      "stroke": "currentColor",
      "stroke-linecap": "round",
      "stroke-linejoin": "round",
      "style": "color: var(--solar-secondary-color, currentColor); opacity: var(--solar-secondary-opacity, 0.5)"
  ...
  [
    "path",
    {
      "d": "M11.4316 7.6193C10.5274 6.71511 10.0753 6.26301 10.0108 5.71092C9.9964 5.58768 9.9964 5.46318 10.0108 5.33994C10.0753 4.78785 10.5274 4.33576 11.4316 3.43156C12.3358 2.52737 12.7879 2.07528 13.3399 2.0108C13.4632 1.9964 13.5877 1.9964 13.7109 2.0108C14.263 2.07528 14.7151 2.52737 15.6193 3.43156L20.5684 8.3807C21.4726 9.28489 21.9247 9.73699 21.9892 10.2891C22.0036 10.4123 22.0036 10.5368 21.9892 10.6601C21.9247 11.2122 21.4726 11.6642 20.5684 12.5684C19.6642 13.4726 19.2122 13.9247 18.6601 13.9892C18.5368 14.0036 18.4123 14.0036 18.2891 13.9892C17.737 13.9247 17.2849 13.4726 16.3807 12.5684L11.4316 7.6193Z",
      "stroke": "currentColor"
    }
  ]
];

export { DumbbellLargeMinimalisticLineDuotoneIcon as default };
