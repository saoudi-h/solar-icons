...
const WhiskLineDuotoneIcon: IconNode = [
  [
    "path",
    {
  ...
  [
    "path",
    {
      "d": "M20.5485 3.45144C21.7566 4.65951 19.0984 8.12279 17.3279 9.89327C15.5573 11.6637 11.2887 15.127 10.0806 13.919C8.87249 12.7109 12.3364 8.44297 14.107 6.67249C15.8775 4.90202 19.3404 2.24337 20.5485 3.45144Z",
      "stroke": "currentColor",
      "style": "color: var(--solar-secondary-color, currentColor); opacity: var(--solar-secondary-opacity, 0.5)"
    }
  ],
...
export { WhiskLineDuotoneIcon as default };
