...
const CalculatorLineDuotoneIcon: IconNode = [
  [
    "path",
    {
  ...
  [
    "path",
    {
      "d": "M8 13H8.009M11.991 13H12M15.991 13H16",
      "stroke": "currentColor",
  ...
  [
    "path",
    {
      "d": "M8 17H8.009M11.991 17H12M15.991 17H16",
      "stroke": "currentColor",
      "stroke-linecap": "round",
      "stroke-linejoin": "round",
      "style": "color: var(--solar-secondary-color, currentColor); opacity: var(--solar-secondary-opacity, 0.5)"
...
export { CalculatorLineDuotoneIcon as default };
