...
const MapArrowUpBoldDuotoneIcon: IconNode = [
  [
    "path",
    {
  ...
  [
    "path",
    {
      "d": "M8.0374 9.85761C7.78266 9.73024 7.47314 9.84107 7.35714 10.1012L3.16447 19.5029C2.49741 20.9987 3.97865 22.5503 5.36641 21.8093L11.2701 18.6573C11.7293 18.4121 12.2697 18.4122 12.7289 18.6573L18.6326 21.8093C20.0204 22.5503 21.5016 20.9987 20.8346 19.5029L19.2629 15.9785C19.0743 15.5557 18.7448 15.2113 18.3307 15.0043L8.0374 9.85761Z",
      "fill": "currentColor"
    }
  ]
];

export { MapArrowUpBoldDuotoneIcon as default };
