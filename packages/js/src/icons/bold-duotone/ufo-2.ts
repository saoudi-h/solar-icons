...
const Ufo2BoldDuotoneIcon: IconNode = [
  [
    "g",
    {
  ...
  [
    "path",
    {
      "fill-rule": "evenodd",
      "clip-rule": "evenodd",
      "d": "M5.67459 7.59375C3.4317 8.35912 2 9.52303 2 10.8265C2 13.1315 6.47715 15.0002 12 15.0002C17.5228 15.0002 22 13.1315 22 10.8265C22 9.52303 20.5683 8.35912 18.3254 7.59375C18.2008 7.88403 17.9937 8.17776 17.6568 8.41211C16.8685 8.96038 15.3013 9.50029 12 9.50029C8.6987 9.50029 7.1315 8.96038 6.34322 8.41211C6.00629 8.17776 5.79918 7.88403 5.67459 7.59375ZM12 13.0003C12.5523 13.0003 13 12.5526 13 12.0003C13 11.448 12.5523 11.0003 12 11.0003C11.4477 11.0003 11 11.448 11 12.0003C11 12.5526 11.4477 13.0003 12 13.0003ZM8 11.0003C8 11.5526 7.55228 12.0003 7 12.0003C6.44772 12.0003 6 11.5526 6 11.0003C6 10.448 6.44772 10.0003 7 10.0003C7.55228 10.0003 8 10.448 8 11.0003ZM17 12.0003C17.5523 12.0003 18 11.5526 18 11.0003C18 10.448 17.5523 10.0003 17 10.0003C16.4477 10.0003 16 10.448 16 11.0003C16 11.5526 16.4477 12.0003 17 12.0003Z",
      "fill": "currentColor"
    }
  ],
  [
    "path",
    {
      "d": "M12 17.2503C12.4142 17.2503 12.75 17.5861 12.75 18.0003V21.0003C12.75 21.4145 12.4142 21.7503 12 21.7503C11.5858 21.7503 11.25 21.4145 11.25 21.0003V18.0003C11.25 17.5861 11.5858 17.2503 12 17.2503Z",
      "fill": "currentColor"
    }
  ]
];

export { Ufo2BoldDuotoneIcon as default };
