...
const SortAlphabeticallyBoldDuotoneIcon: IconNode = [
  [
    "path",
    {
      "fill-rule": "evenodd",
  ...
  [
    "path",
    {
      "fill-rule": "evenodd",
      "clip-rule": "evenodd",
      "d": "M17.1841 6.69223C17.063 6.42309 16.7953 6.25 16.5002 6.25C16.2051 6.25 15.9374 6.42309 15.8162 6.69223L11.3162 16.6922C11.1463 17.07 11.3147 17.514 11.6924 17.6839C12.0701 17.8539 12.5141 17.6855 12.6841 17.3078L14.1215 14.1136H18.8789L20.3162 17.3078C20.4862 17.6855 20.9302 17.8539 21.308 17.6839C21.6857 17.514 21.8541 17.07 21.6841 16.6922L17.1841 6.69223ZM16.5002 8.82764L14.7965 12.6136H18.2039L16.5002 8.82764Z",
      "fill": "currentColor"
    }
  ]
];

export { SortAlphabeticallyBoldDuotoneIcon as default };
