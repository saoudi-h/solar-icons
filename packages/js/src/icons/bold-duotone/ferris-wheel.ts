 ...
 */
export const FerrisWheelBoldDuotoneIcon: IconNode[] = [
  [
    "path",
    {
      "fill-rule": "evenodd",
  ...
  [
    "path",
    {
      "d": "M9.82112 12.6779L4.84452 21.6358C4.64336 21.9979 4.77382 22.4545 5.1359 22.6557C5.49799 22.8568 5.95459 22.7264 6.15575 22.3643L11.0377 13.5768C10.5524 13.3955 10.1321 13.0811 9.82112 12.6779Z",
      "fill": "currentColor"
    }
  ],
  [
    "path",
    {
      "d": "M12.9626 13.5768L17.8445 22.3643C18.0457 22.7264 18.5023 22.8568 18.8644 22.6557C19.2265 22.4545 19.3569 21.9979 19.1558 21.6358L14.179 12.6777C13.8681 13.0809 13.4478 13.3954 12.9626 13.5768Z",
      "fill": "currentColor"
    }
  ],
  [
    "path",
    {
      "d": "M12 5.25C11.0335 5.25 10.25 4.4665 10.25 3.5C10.25 2.5335 11.0335 1.75 12 1.75C12.9665 1.75 13.75 2.5335 13.75 3.5C13.75 4.4665 12.9665 5.25 12 5.25Z",
      "fill": "currentColor"
    }
  ],
  [
    "path",
    {
      "d": "M2.75 7.5C2.75 6.5335 3.5335 5.75 4.5 5.75C5.4665 5.75 6.25 6.5335 6.25 7.5C6.25 8.4665 5.4665 9.25 4.5 9.25C3.5335 9.25 2.75 8.4665 2.75 7.5Z",
      "fill": "currentColor"
    }
  ],
  [
    "path",
    {
      "d": "M19.5 5.75C18.5335 5.75 17.75 6.5335 17.75 7.5C17.75 8.4665 18.5335 9.25 19.5 9.25C20.4665 9.25 21.25 8.4665 21.25 7.5C21.25 6.5335 20.4665 5.75 19.5 5.75Z",
      "fill": "currentColor"
    }
  ],
  [
    "path",
    {
      "d": "M19.5 14.25C18.5335 14.25 17.75 15.0335 17.75 16C17.75 16.9665 18.5335 17.75 19.5 17.75C20.4665 17.75 21.25 16.9665 21.25 16C21.25 15.0335 20.4665 14.25 19.5 14.25Z",
      "fill": "currentColor"
    }
  ],
  [
    "path",
    {
      "d": "M4.5 14.25C3.5335 14.25 2.75 15.0335 2.75 16C2.75 16.9665 3.5335 17.75 4.5 17.75C5.4665 17.75 6.25 16.9665 6.25 16C6.25 15.0335 5.4665 14.25 4.5 14.25Z",
      "fill": "currentColor"
    }
  ],
  [
    "path",
    {
      "d": "M10.25 19.5C10.25 20.4665 11.0335 21.25 12 21.25C12.9665 21.25 13.75 20.4665 13.75 19.5C13.75 18.5335 12.9665 17.75 12 17.75C11.0335 17.75 10.25 18.5335 10.25 19.5Z",
      "fill": "currentColor"
    }
  ]
];
