...
import type { DynamicIconProps } from '../../lib/dynamic-icon'
${styleImports}
...
const main = async () => {
    try {
        ...
        const aliases = buildAliasMap(descriptions)
        const indexFiles = generateIndexes(result.icons, result.groups, aliases)
