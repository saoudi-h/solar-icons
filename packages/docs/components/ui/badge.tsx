    ...
    'inline-flex items-center border px-2.5 py-1 text-sm font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-nowrap rounded-full',
    {
        variants: {
            ...
            colors: {
                ...
                destructive: 'bg-destructive text-destructive-foreground hover:bg-destructive/80 border-destructive',
                warning: 'bg-warning text-warning hover:bg-warning/80 border-warning',
