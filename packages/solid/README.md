...
The `@solar-icons/solid` package provides SolidJS components for the Solar icon set. It's designed for performance with minimal bundle size and full tree-shaking support.
...
import { Cart, Bag } from '@solar-icons/solid/category/shopping/Linear';
