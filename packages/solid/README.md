...
SolidJS components for Solar Icons. This package provides 8,274 SVG icons across 6 styles (Bold, Broken, Linear, Outline, Bold Duotone, Line Duotone), optimized for Solid applications.

## Features

- **8,274 SVGs:** 1,379 unique icons in 6 styles. Designed by 480 Design.
...
For installation guides, API reference, and a searchable icon catalog, visit the [Solid Documentation](https://solar-icons.vercel.app/docs/v2/packages/solid).
