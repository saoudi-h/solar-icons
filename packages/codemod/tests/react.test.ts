...
describe('transformReact', () => {
    ...
    it('cleans a redundant alias emitted by another transform', () => {
        const source =
            "import { HomeBoldIcon as HomeBold } from '@solar-icons/react'\n\nexport const App = () => <HomeBold />"

        expect(transformReact(source).code).toBe(
            "import { HomeBoldIcon } from '@solar-icons/react'\n\nexport const App = () => <HomeBoldIcon />"
        )
    })
    ...
    it('cleans aliases generated by an earlier migration without changing explicit aliases', () => {
        const result = transformReact(
            [
                "import { ArrowUpIcon as ArrowUp, UnreadIcon as Check } from '@solar-icons/react/linear'",
                '',
                'export const App = () => <><ArrowUp /><Check /></>',
            ].join('\n')
        )

        expect(result.code).toBe(
            [
                "import { ArrowUpIcon, UnreadIcon as Check } from '@solar-icons/react/linear'",
                '',
                'export const App = () => <><ArrowUpIcon /><Check /></>',
            ].join('\n')
        )
    })

    it('cleans an alias left behind by an icon rename', () => {
        const result = transformReact(
            "import { MinimalisticMagnifierIcon as MinimalisticMagnifer } from '@solar-icons/react/linear'\n\n<MinimalisticMagnifer />"
        )

        expect(result.code).toBe(
            "import { MinimalisticMagnifierIcon } from '@solar-icons/react/linear'\n\n<MinimalisticMagnifierIcon />"
        )
    })
