...
- `src/icon-renames.ts` mirrors all 37 rows in the v2 icon-renames guide and also contains the current catalogue normalizations for deprecated file/chat names. Keep both tables and their documentation in sync.
