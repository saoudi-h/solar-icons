...
1,380 icons in 6 styles, packaged for modern web and mobile frameworks.
...
- **8,280 variations**: 1,380 unique icons across 30+ categories, each available in six styles (`Bold`, `Linear`, `Outline`, `BoldDuotone`, `LineDuotone`, and `Broken`).
