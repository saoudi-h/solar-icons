 ...
 */
export const FORWARD_REFERENCE_OVERRIDES: Record<
    string,
    { reference: string; referenceId: string; note: string }
> = {
    S0081: {
        reference: 'dribbble',
        referenceId: 'L0582',
        note: 'Same basketball symbol; Lucide names the brand mark, but the rendered Solar symbol is interchangeable in this direction.',
    },
    S0042: {
        reference: 'archive',
        referenceId: 'L0056',
        note: 'Minimal archive keeps the same archive object; the minimal enclosure is stylistic.',
    },
    S0079: {
        reference: 'banknote',
        referenceId: 'L0139',
        note: 'Same banknote object; the internal bill layout is a drawing variant.',
    },
    S0111: {
        reference: 'bluetooth',
        referenceId: 'L0194',
        note: 'Same Bluetooth symbol; the circular enclosure is a Solar style variant.',
    },
    S0112: {
        reference: 'bluetooth',
        referenceId: 'L0194',
        note: 'Same Bluetooth symbol; the square enclosure is a Solar style variant.',
    },
    S0113: {
        reference: 'bluetooth-searching',
        referenceId: 'L0197',
        note: 'Same Bluetooth searching/wave state; the radio-wave treatment differs.',
    },
    S0118: {
        reference: 'bolt',
        referenceId: 'L0199',
        note: 'Same lightning-bolt symbol; the circular enclosure is decorative.',
    },
    S0120: {
        reference: 'bomb',
        referenceId: 'L0200',
        note: 'Same bomb object; the emoji treatment is stylistic.',
    },
    S0133: {
        reference: 'bookmark',
        referenceId: 'L0229',
        note: 'Same bookmark object; the circular enclosure is decorative.',
    },
    S0134: {
        reference: 'bookmark',
        referenceId: 'L0229',
        note: 'Same opened bookmark object; Lucide uses the standard bookmark silhouette.',
    },
    S0135: {
        reference: 'bookmark',
        referenceId: 'L0229',
        note: 'Same bookmark object; the square enclosure is decorative.',
    },
    S0136: {
        reference: 'bookmark',
        referenceId: 'L0229',
        note: 'Same bookmark object; the minimal square treatment is stylistic.',
    },
    S0504: {
        reference: 'signal-high',
        referenceId: 'L1445',
        note: 'Same high-signal/quality indicator; Lucide uses the canonical signal-strength drawing.',
    },
    S0159: {
        reference: 'phone-missed',
        referenceId: 'L1232',
        note: 'Same cancelled/missed phone-call state; the handset and X treatment differ.',
    },
    S0160: {
        reference: 'phone-missed',
        referenceId: 'L1232',
        note: 'Same cancelled/missed phone-call state; the rounded handset treatment differs.',
    },
    S0170: {
        reference: 'switch-camera',
        referenceId: 'L1602',
        note: 'Same camera-switch/rotate action; Lucide uses the canonical switch-camera glyph.',
    },
    S0179: {
        reference: 'wallet-cards',
        referenceId: 'L1776',
        note: 'Same cardholder/wallet-with-card object; Lucide names the wallet-card construction.',
    },
}
