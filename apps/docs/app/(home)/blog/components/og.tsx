...
// Satori (used by Next's ImageResponse) does not reliably parse variable TTFs.
// Keep the variable family for the UI, but use a bundled static cut for OG images.
const HEADING_FONT = 'node_modules/@fontsource/aleo/files/aleo-latin-700-normal.woff'
