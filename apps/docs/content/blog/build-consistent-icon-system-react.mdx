...
The package includes 1,379 distinct icons in six styles. Each style has its own import path, so the import tells you which visual treatment the component uses.
...
Solar Icons provides 1,379 icons across six styles, plus packages for other frameworks and framework-free use. The same separation between style choice and shared defaults gives the team a stable starting point as the interface grows.
