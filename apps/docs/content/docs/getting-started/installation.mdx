...
The `@solar-icons/svelte` package provides Svelte 5 components with runes for optimal performance and minimal bundle size.
...
The `@solar-icons/solid` package provides lightweight SolidJS components designed for optimal performance and minimal bundle size.
...
The `@solar-icons/angular` package provides Angular 17-21 components with modern signals and minimal bundle size.
