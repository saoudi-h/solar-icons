...
Import individual icon components for use in your templates.
...
All import methods are tree-shakeable, ensuring only the icons you use are included in your bundle.
...
<Callout type="info" title="IDE Warnings">
    When passing a component class directly, the Angular compiler might warn you that the component
    is unused (`NG8113`). This is a known limitation of static analysis with dynamic references; you
