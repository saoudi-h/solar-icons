...
description: Upgrade @solar-icons/svelte to v2.
icon: svelte
---

## Try the codemod first

The [V2 codemod](/docs/v2/migration-to-v2/codemod) can rewrite common Svelte imports and reports legacy category syntax for manual migration. Run its preview before applying the Svelte 5 and API changes below.
