...
The [V2 codemod](/docs/v2/migration-to-v2/codemod) can rename deterministic Angular imports and selectors in inline or resolvable external templates. It reports templates and API changes it cannot safely infer, which you should complete with this guide.
