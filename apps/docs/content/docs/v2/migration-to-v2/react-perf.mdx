...
The [V2 codemod](/docs/v2/migration-to-v2/codemod) can rewrite the common React-Perf import patterns into `@solar-icons/react` v2 imports. Review its diagnostics before removing `@solar-icons/react-perf`; unusual category and namespace patterns still need a manual decision.
