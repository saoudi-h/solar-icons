...
description: Upgrade @solar-icons/solid to v2.
icon: solid
---

## Try the codemod first

The [V2 codemod](/docs/v2/migration-to-v2/codemod) rewrites deterministic Solid imports and reports category or namespace cases that need a manual choice. Review its preview before following this guide.
