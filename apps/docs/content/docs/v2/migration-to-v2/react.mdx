...
`SolarProvider`, `secondaryColor` / `secondaryOpacity`, and `strokeWidth` are now part of every web framework package. See the [React package page](/docs/v2/frameworks/react) for the full API.
