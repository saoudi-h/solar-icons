...
For changes before v2, see the [GitHub releases page](https://github.com/saoudi-h/solar-icons/releases) or the [legacy changelog](/docs/legacy/community/changelog).
