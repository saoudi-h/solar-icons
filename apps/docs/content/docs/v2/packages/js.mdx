...
Since Solar Icons contains exactly 8,274 icons across different styles, a traditional global script (UMD) would be massive. Instead, the package is distributed natively as ES Modules (ESM).
