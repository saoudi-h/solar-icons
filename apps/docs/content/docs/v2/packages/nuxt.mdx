...
- **Auto-imported icons:** all 8,280 static icons + 1,380 dynamic icons
...
| --------------------------- | ------------------------------- | ------------------------- |
| `#solar-icons`              | `@solar-icons/vue`              | Main barrel (8,280 icons) |
| `#solar-icons/lib`          | `@solar-icons/vue/lib`          | SolarProvider, useSolar   |
| `#solar-icons/dynamic`      | `@solar-icons/vue/dynamic`      | Dynamic icons (1,380)     |
...
The provider and composable work identically to the Vue package. See the [Vue documentation](/docs/v2/packages/vue#solarprovider) for props, CSS variables, and usage examples.
