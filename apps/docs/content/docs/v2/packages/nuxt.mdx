...
- **Auto-imported icons:** all 8,706 static icons + 1,451 dynamic icons
...
| --------------------------- | ------------------------------- | ------------------------- |
| `#solar-icons`              | `@solar-icons/vue`              | Main barrel (8,706 icons) |
| `#solar-icons/lib`          | `@solar-icons/vue/lib`          | SolarProvider, useSolar   |
| `#solar-icons/dynamic`      | `@solar-icons/vue/dynamic`      | Dynamic icons (1,451)     |
