...
V2 kept deprecated alias exports for renames (so old code kept compiling). V3 drops them: the rename is a hard break, the new name is the only valid one. This keeps the package surface clean and removes ambiguity about which name to use.
