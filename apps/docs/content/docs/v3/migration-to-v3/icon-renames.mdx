...
These were deprecated aliases in V2 (`@deprecated` exports pointing to the correct name). V3 drops the aliases.
...
pre-V3 kept deprecated alias exports for renames (so old code kept compiling). V3 drops them: the rename is a hard break, the new name is the only valid one.
