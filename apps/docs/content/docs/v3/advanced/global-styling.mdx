...
- `--solar-duotone-color` defaults to `currentColor`. Without a provider, the accent inherits the icon's primary color.
- `--solar-duotone-opacity` defaults to `0.5`. This is the standard Solar duotone look.
