...
Every icon renders with two CSS classes (Angular static components add the style suffix):

| Class                                    | Applies to                                                |
| ---------------------------------------- | --------------------------------------------------------- |
| `solar`                                  | Every icon                                                |
| `solar-{name}` or `solar-{name}-{style}` | The icon, with style suffix for Angular static components |

Use `.solar` for global icon styling. Use `.solar-heart` or `.solar-heart-bold` for per-icon overrides.
