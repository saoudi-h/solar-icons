...
export const getIconsByCategory = (category: string) => {
    switch (category) {
        ...
        case 'Weather':
            return {
                inner: [Clouds, CloudBolt, CloudCross, CloudCheck, Fog, CloudPlus, CloudSun2],
                outer: [
                    CloudRain,
                    CloudSun,
                    CloudBoltMinimalistic,
        ...
        case 'Astronomy':
            return {
                inner: [Men, BlackHole3, BlackHole, Women, Planet2, Rocket2, Asteroid],
                outer: [
                    Rocket,
                    Atom,
                    Earth,
        ...
        case 'Time':
            return {
                inner: [ClockCircle, History, ClockSquare, AlarmPlay, Alarm, AlarmSleep, AlarmAdd],
                outer: [
                    AlarmTurnOff,
                    StopwatchPlay,
                    Hourglass,
        ...
        case 'Medicine':
            return {
                inner: [JarOfPills, Bacteria, Dna, Syringe, JarOfPills2, BenzeneRing, Pills3],
                outer: [
                    Dropper2,
                    Thermometer,
                    Pills2,
        ...
        case 'Food':
            return {
                inner: [CupHot, Mug, TeaCup, Bottle, Donut, ChefHatMinimalistic, DonutBitten],
                outer: [
                    ChefHatHeart,
                    Corkscrew,
                    ChefHat,
        ...
        case 'Like':
            return {
                inner: [Heart, Star, HeartLock, HeartUnlock, MedalRibbon, Dislike, StarShine],
                outer: [
                    Hearts,
                    HeartShine,
                    HeartBroken,
