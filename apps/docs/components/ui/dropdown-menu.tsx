    ...
    <DropdownMenuPrimitive.Item
        ...
        className={cn(
            `
              ...
              py-1.5 text-sm outline-hidden transition-colors select-none
...
>(({ className, children, ...props }, ref) => (
    <DropdownMenuPrimitive.CheckboxItem
        ...
        className={cn(
            `
              relative flex cursor-default items-center rounded-sm py-1.5 pr-2
              pl-8 text-sm outline-hidden transition-colors select-none
              focus:bg-accent focus:text-accent-foreground
              data-disabled:pointer-events-none data-disabled:opacity-50
            `,
            className
...
>(({ className, children, ...props }, ref) => (
    <DropdownMenuPrimitive.RadioItem
        ...
        `}>
            <DropdownMenuPrimitive.ItemIndicator>
                <AltArrowLeft className="h-2 w-2" />
            </DropdownMenuPrimitive.ItemIndicator>
        </span>
        {children}
    </DropdownMenuPrimitive.RadioItem>
