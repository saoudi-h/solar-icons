...
export function IconsContent() {
    return (
        ...
        <main
            className="
              relative flex w-full flex-1 flex-col justify-start gap-9 overflow-hidden bg-background
              p-4 text-center
              md:gap-12 md:px-10 md:py-[34px]
            ">
            <div
                className={`relative container flex w-full flex-1 flex-col items-center self-center`}>
                <div
                    className={`
                      absolute container mx-4 size-full gap-2 self-center overflow-hidden
                      rounded-2xl bg-default-100 px-3 py-12
                    ...
                    <div
                        className={`
                          ...
                          bg-linear-to-b from-primary/80 to-transparent blur-3xl
                        `}></div>
                    <div
                        className={`
                          absolute top-0 left-2/3 size-1/3 -translate-1/2 rounded-full
                          bg-linear-to-b from-red-400/50 to-transparent blur-3xl
                        `}></div>
                    <div
                    ...
                    />
                    <div
                        className={`absolute top-0 left-1/2 size-[300%] -translate-1/2`}
                        style={{
                            background:
