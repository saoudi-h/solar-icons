            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-5">
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-3">
                        <input
                            ...
                            onChange={e => solar.setColor(e.target.value)}
                            className="
                        ...
                        <input
                            ...
                            onChange={e => solar.setColor(e.target.value)}
                            className="
                          flex-1 rounded-lg border border-slate-600 bg-slate-700 px-3 py-2 font-mono
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        onChange={e => solar.setSize(parseInt(e.target.value))}
                        className="
                ...
                <div
                    className={`
                  space-y-2
                  ${!isLinearLike(selectedStyle) ? `pointer-events-none opacity-30` : ''}
                `}>
                    <label className="text-sm font-medium text-slate-300">
                        Stroke:{' '}
                        <span
                    ...
                    <input
                        ...
                        onChange={e => solar.setStrokeWidth(parseFloat(e.target.value))}
            ...
            {isDuotone(selectedStyle) && (
                <div className="border-t border-slate-700/50 pt-6">
                    <div className="mb-4 flex items-center gap-2">
                        <span
                            className="
                          text-sm font-semibold tracking-wide text-blue-400 uppercase
                        ">
                            Duotone
                        </span>
                        <span
                            className="
                          rounded-sm bg-slate-700/50 px-2 py-0.5 text-xs text-slate-500
                        ">
                            --solar-secondary-color / --solar-secondary-opacity
                        </span>
                    </div>
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-3">
                                <input
                                    ...
                                    onChange={e => solar.setSecondaryColor(e.target.value)}
                                    className="
                                  size-10 cursor-pointer rounded-lg border-0
                                "
                                />
                                <input
                                    ...
                                    onChange={e => solar.setSecondaryColor(e.target.value)}
                                    className="
                                  flex-1 rounded-lg border border-slate-600 bg-slate-700 px-3 py-2
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                onChange={e =>
                                    solar.setSecondaryOpacity(parseFloat(e.target.value))
                                }
                                className="
                ...
                {filteredIcons.map(name => {
                    ...
                    return (
                        <div
                          ...
                          rounded-xl border border-slate-700/30 bg-slate-800/30 p-4 transition-all
                        ...
                        "
                            ...
                            <span
                                className="
                              w-full truncate text-center text-xs text-slate-500 transition-colors
