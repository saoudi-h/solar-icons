    ...
    <div class="space-y-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <div class="space-y-2" :class="{ 'opacity-30 pointer-events-none': !isLinearLike }">
                <label class="text-sm font-medium text-slate-300"
                    >Stroke:
                    <span class="text-amber-400">{{ solar.strokeWidth ?? 1.5 }}</span></label
                >
                <input
                    type="range"
                    min="0.5"
                    ...
                    @input="
                        solar.setStrokeWidth(parseFloat(($event.target as HTMLInputElement).value))
                    "
                    class="w-full accent-amber-500" />
            </div>
            <div class="space-y-2">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center gap-3">
                        <input
                            ...
                            @input="
                                solar.setSecondaryColor(($event.target as HTMLInputElement).value)
                            "
